      ...
      <main>
        ...
        <section className={styles.wrapper}>
          ...
          <div className={styles.content}>
            ...
            <p>
              We have the massive goal to satisfy our clients with the
              innovative projects and that’s why Red Blox remains the reliable
              one for every business. Our team mates ready to support every
              project to get its unique identity. Technology is going to rule
              the world and we make it easily accessible to you.
            </p>
          </div>
        ...
        <div>
          <section className={styles.profile}>
            ...
            <div className={styles.right}>
              ...
              <p>
                Iam pretty sure cheese is the greatest invention in the history
              </p>
              <div>
